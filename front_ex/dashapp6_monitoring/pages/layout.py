    ...
    layout = html.Div([
        html.Div([
            ...
            html.Div([
                html.Div(
                    [
                        html.H5("Отчет по мониторингу устранения недостатков"),
                        html.Br([]),
                        html.P("\
            ...
            html.Div([
                dcc.Tabs(id='dashboard6-tabs', value='tab-1', children=[
                    dcc.Tab(label='Мониторинг', value='tab-1', className="tab",),
                    dcc.Tab(label='Просроченые планы мероприятий', value='tab-2', className="tab",),
                    dcc.Tab(label='Выполнение годового плана', value='tab-3', className="tab",),
                    dcc.Tab(label='Планы мероприятий', value='tab-4', className="tab",),
                    dcc.Tab(label='Наблюдения', value='tab-5', className="tab",),
