    ...
    dbc.CardBody(
        [
            ...
            dash_table.DataTable(
                ...
                #data=df_clients[['Наименование клиента','Изменение доли основного груза','Разных грузов у клиента']].to_dict('rows'), 
...
posredniki_card = dbc.Card(
    dbc.CardBody(
        [
            ...
            html.Label("В будущем тут будет информация о посредничестве клиента",
                        style={'font-size': 14,
                                'text-align': 'left',
                                'color': '#808080'},
                    ),
...
cards_2 = html.Div(
    [
        html.Div(posredniki_card, className='six columns'),
            ...
            dbc.Row([
                ...
                dash_table.DataTable(
                    ...
                    columns=[
                        ...
                        {'name': 'ИНН', 'id': 'ИНН клиента', 'type': 'text'},
                        {'name': 'ОГРН', 'id': 'ОГРН клиента', 'type': 'text'},
                        {'name': 'Дата регистрации', 'id': 'Дата регистрации клиента', 'type': 'datetime'},
                        {'name': 'ОКВЭД', 'id': 'ОКВЭД', 'type': 'text'},
