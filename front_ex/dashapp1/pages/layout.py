...
def create_layout():
    ...
    with engine_cons.connect() as con:
        layout2 = html.Div([
            html.Div([
                    ...
                    html.Div(
                        [
                            ...
                            html.P("\
                                ...
                                Отчет построен на основе данных по счету 9402110000 - Недостачи по НзЧ (номерной) в SAP S/4. Изменение недостачи за период показывает разницу между \
                                входящим сальдо на начало периода и исходящим сальдо на конец периода.",
                                style={"color": "#ffffff"},
                                className="row",
                            ),
                            html.P(
                                ...
                                + '{0:,}'.format(round(con.execute(text(
