    ...
    layout2 = html.Div([
        html.Div([
            ...
            html.Div([
                html.Div(
                    [
                        html.H5("Отчет об отставании бухгалтерского учета запчастей от оперативного учета (нагон)"),
                        html.Br([]),
                        html.P("\
                            Данный отчет содержит информацию о количестве операций, проведенных в оперативном учете по данным УДВ, но не проведенным в бухгалтерском учете SAP.\
                            Отчет построен на основе данных из УДВ. \
                            ",
                            style={"color": "#ffffff"},
                            className="row",
                        ),
                        html.P(
                            ...
                            "** количество непроведенных операций составляет **"
